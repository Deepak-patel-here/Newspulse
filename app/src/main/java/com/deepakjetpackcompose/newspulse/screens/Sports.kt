...
@Composable
fun Sports(navController: NavController,newsViewModel: NewsViewModel,modifier: Modifier = Modifier) {
    ...
    var sportsData by remember { mutableStateOf<NewsResponse?>(null) }
    ...
    Column(modifier=modifier) {
        Row {
            ...
            Icon(
                ...
                modifier = Modifier.clickable { newsViewModel.fetchNewsCategory(category = "sports") }
            )
        }
        if (isLoading) {
