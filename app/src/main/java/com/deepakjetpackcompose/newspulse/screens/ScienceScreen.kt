...
@Composable
fun ScienceScreen(navController: NavController, newsViewModel: NewsViewModel, modifier: Modifier = Modifier) {
    ...
    Column(modifier=modifier) {
        Row {
            ...
            Icon(
                ...
                modifier = Modifier.clickable { newsViewModel.fetchNewsCategory(category = "science") }
            )
        }
        if (isLoading) {
